...
load_dotenv("/home/admin1/fusion5dsti/.env")
OPENAI_API_KEY = os.getenv("OPENAI_API_KEY") # Create a .env file and write: OPENAI_API_KEY="insert-your-openai-token"
llm = ChatOpenAI(model_name="gpt-4o", openai_api_key=OPENAI_API_KEY)

# data from https://www.kaggle.com/datasets/helgirewirthana/world-stock-prices-daily-updating
...
def activate_agent(stocks_chosen):
    ...
    response = agent.invoke({
        "input": "What is the dataset telling us about the performance of the stocks? "
